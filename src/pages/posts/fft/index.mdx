...
<Image src={pure} alt="pure sine wave and frequency" layout="fixed" />
...
<Image src={noisy} alt="noisy sine wave and frequency" layout="fixed" />
...
<Image src={ft} alt="fourier transform integral" layout="fixed" />
...
<Image src={dft} alt="discrete fourier transform" layout="fixed" />
