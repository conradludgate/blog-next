...
<Image src={pure} alt="pure sine wave and frequency" sizes="100vw" style={{width: "100%", height:"auto"}} />
...
<Image src={noisy} alt="noisy sine wave and frequency" sizes="100vw" style={{width: "100%", height:"auto"}} />
...
<Image src={ft} alt="fourier transform integral" sizes="100vw" style={{width: "100%", height:"auto"}} />
...
<Image src={dft} alt="discrete fourier transform" sizes="100vw" style={{width: "100%", height:"auto"}} />
