...
To calculate the probabilities of two mutually exclusive events occuring you can multiply their individual
...
A very nice feature of the insert operation is that it's associative. What that means is that
...
It is also commutative. This means that it can be further simplified as
